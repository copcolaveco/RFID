    ...
    Public Function buscar(ByVal o As Object) As dCliente
        ...
        Try
            ...
            If Ds.Tables(0).Rows.Count > 0 Then
                ...
                p.OBSERVACIONES = CType(unaFila.Item(33), String)
                p.FAC_RSOCIAL = CType(unaFila.Item(34), String)
                p.FAC_CEDULA = CType(unaFila.Item(35), String)
                p.FAC_RUT = CType(unaFila.Item(36), String)
                p.FAC_DIRECCION = CType(unaFila.Item(37), String)
                p.FAC_LOCALIDAD = CType(unaFila.Item(38), String)
                p.FAC_DEPARTAMENTO = CType(unaFila.Item(39), Integer)
                p.FAC_CPOSTAL = CType(unaFila.Item(40), String)
                p.FAC_GIRO = CType(unaFila.Item(41), Integer)
                p.COB_NOMBRE_TELEFONO1 = CType(unaFila.Item(42), String)
                p.FAC_TELEFONOS = CType(unaFila.Item(43), String)
                p.COB_NOMBRE_TELEFONO2 = CType(unaFila.Item(44), String)
                p.COB_TELEFONO2 = CType(unaFila.Item(45), String)
                p.COB_NOMBRE_CELULAR1 = CType(unaFila.Item(46), String)
                p.COB_CELULAR1 = CType(unaFila.Item(47), String)
                p.COB_NOMBRE_CELULAR2 = CType(unaFila.Item(48), String)
                p.COB_CELULAR2 = CType(unaFila.Item(49), String)
                p.COB_NOMBRE_EMAIL1 = CType(unaFila.Item(50), String)
                p.COB_EMAIL1 = CType(unaFila.Item(51), String)
                p.COB_NOMBRE_EMAIL2 = CType(unaFila.Item(52), String)
                p.COB_EMAIL2 = CType(unaFila.Item(53), String)
                p.FAC_FAX = CType(unaFila.Item(54), String)
                p.FAC_EMAIL = CType(unaFila.Item(55), String)
                p.FAC_CONTACTO = CType(unaFila.Item(56), String)
                p.FAC_OBSERVACIONES = CType(unaFila.Item(57), String)
                p.FAC_LISTA = CType(unaFila.Item(58), Integer)
                p.FAC_CONTADO = CType(unaFila.Item(59), Integer)
                p.NOT_EMAIL_FRASCOS1 = CType(unaFila.Item(60), String)
                p.NOT_EMAIL_FRASCOS2 = CType(unaFila.Item(61), String)
                p.NOT_EMAIL_MUESTRAS1 = CType(unaFila.Item(62), String)
                p.NOT_EMAIL_MUESTRAS2 = CType(unaFila.Item(63), String)
                p.NOT_EMAIL_ANALISIS1 = CType(unaFila.Item(64), String)
                p.NOT_EMAIL_ANALISIS2 = CType(unaFila.Item(65), String)
                p.NOT_EMAIL_GENERAL1 = CType(unaFila.Item(66), String)
                p.NOT_EMAIL_GENERAL2 = CType(unaFila.Item(67), String)
                Return p
            End If
            Return Nothing
